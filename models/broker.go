...
type Broker struct {
	...
	HasOnlineAccount           string `json:"has_online_account" gorm:"Column:has_online_account;size:100"`
	ModificationDate           string `json:"modification_date" gorm:"Column:modification_date;size:100"`
	IsMmtpUser                 int64  `json:"is_mmtp_user" gorm:"Column:modification_date"`
	...
	MmtpUserId                 int64  `json:"mmtp_user_id" gorm:"Column:comex_visitor_id"`
	ComexEconomyAccount        string `json:"comex_economy_account" gorm:"Column:comex_economy_account;size:100"`
	IsPortfo                   bool   `json:"is_portfo" gorm:"Column:is_portfo"`
